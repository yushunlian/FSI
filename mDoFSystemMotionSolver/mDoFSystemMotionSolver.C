...
namespace Foam
{
    defineTypeNameAndDebug(mDoFSystemMotionSolver, 0);

    addToRunTimeSelectionTable
    (
        motionSolver,
        mDoFSystemMotionSolver,
        dictionary
    );
}
...
Foam::mDoFSystemMotionSolver::mDoFSystemMotionSolver
(
    const polyMesh& mesh,
...
Foam::mDoFSystemMotionSolver::curPoints() const
{
    return points0() + pointDisplacement_.primitiveField();
}


void Foam::mDoFSystemMotionSolver::solve()
{
...
bool Foam::mDoFSystemMotionSolver::write() const
{
    IOdictionary dict
    (
        IOobject
