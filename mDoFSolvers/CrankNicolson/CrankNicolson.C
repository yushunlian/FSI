...
namespace Foam
{
namespace mDoFSolvers
{
    defineTypeNameAndDebug(CrankNicolson, 0);
    addToRunTimeSelectionTable(mDoFSolver, CrankNicolson, dictionary);
}
}
...
Foam::mDoFSolvers::CrankNicolson::CrankNicolson
(
    const dictionary& dict,
    mDoFSystemMotion& body
)
:
    mDoFSolver(body),
...
void Foam::mDoFSolvers::CrankNicolson::solve
(
    bool firstIter,
