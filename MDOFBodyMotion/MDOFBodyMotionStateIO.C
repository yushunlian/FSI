...
#include "MDOFBodyMotionState.H"
#include "IOstreams.H"

// * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * * //

void Foam::MDOFBodyMotionState::write(dictionary& dict) const
{
...
void Foam::MDOFBodyMotionState::write(Ostream& os) const
{
...
(
    Istream& is, MDOFBodyMotionState& sDoFRBMS
)
{
    ...
    (
        "Foam::Istream& Foam::operator>>"
        "(Foam::Istream&, Foam::MDOFBodyMotionState&)"
    );
...
(
    Ostream& os,
    const MDOFBodyMotionState& sDoFRBMS
)
{
    ...
    (
        ...
        "const Foam::MDOFBodyMotionState&)"
    );
