...
bool Foam::MDOFBodyMotion::read(const dictionary& dict)
{
...
void Foam::MDOFBodyMotion::write(Ostream& os) const
{
    ...
    if (!restraints_.empty())
    {
        ...
        forAll(restraints_, rI)
        {
            ...
            os.writeKeyword("MDOFBodyMotionRestraint")
    ...
    if (!constraints_.empty())
    {
        ...
        forAll(constraints_, rI)
        {
            ...
            os.writeKeyword("MDOFBodyMotionConstraint")
                << constraintType << token::END_STATEMENT << nl;

            constraints_[rI].MDOFBodyMotionConstraint::write(os);
