...
void Foam::MDOFBodyMotion::applyRestraints()
{
...
Foam::MDOFBodyMotion::MDOFBodyMotion()
:
    motionState_(),
    motionState0_(),
    restraints_(),
...
void Foam::MDOFBodyMotion::addRestraints
(
    const dictionary& dict
)
{
...
void Foam::MDOFBodyMotion::addConstraints
(
    const dictionary& dict
)
{
...
void Foam::MDOFBodyMotion::updateAcceleration
(
...
void Foam::MDOFBodyMotion::update
(
    bool firstIter,
    const vector& fGlobal,
    const vector& tauGlobal,
...
void Foam::MDOFBodyMotion::status() const
{
...
Foam::tmp<Foam::pointField> Foam::MDOFBodyMotion::transform
(
