...
void Foam::mDoFSystemMotionState::write(dictionary& dict) const
{
...
void Foam::mDoFSystemMotionState::write(Ostream& os) const
{
...
(
    Istream& is, mDoFSystemMotionState& sDoFRBMS
)
{
    ...
    (
        "Foam::Istream& Foam::operator>>"
        "(Foam::Istream&, Foam::mDoFSystemMotionState&)"
    );
...
(
    Ostream& os,
    const mDoFSystemMotionState& sDoFRBMS
)
{
    ...
    (
        ...
        "const Foam::mDoFSystemMotionState&)"
    );
