...
bool Foam::mDoFSystemMotion::read(const dictionary& dict)
{
...
void Foam::mDoFSystemMotion::write(Ostream& os) const
{
    ...
    if (!restraints_.empty())
    {
        ...
        forAll(restraints_, rI)
        {
            ...
            writeEntry(os, "mDoFSystemMotionRestraint", restraintType);
    ...
    if (!constraints_.empty())
    {
        ...
        forAll(constraints_, rI)
        {
            ...
            writeEntry(os, "mDoFSystemMotionConstraint", constraintType);

            constraints_[rI].mDoFSystemMotionConstraint::write(os);
